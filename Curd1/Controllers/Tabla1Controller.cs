...
namespace Curd1.Controllers
{
    public class Tabla1Controller : Controller
    {
        private BaseDeDatos1Entities db = new BaseDeDatos1Entities();
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,texto")] Tabla1 tabla1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,texto")] Tabla1 tabla1)
        {
            if (ModelState.IsValid)
            {
